...
export const metadata: Metadata = {
  title: "Responsible Gaming | Bonu-s.com",
  description:
    "Navigate the complexities of casino payment methods with ease, thanks to Bonu-s.com's comprehensive Payments guide. From credit cards and e-wallets to cryptocurrencies, we cover all the options, detailing the pros and cons to help you make informed decisions. Learn about processing times, fees, and security measures so you can deposit and withdraw funds with confidence. Your seamless gaming experience starts with choosing the right payment method, and we're here to guide you every step of the way!",
};
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          At Bonu-s.com, we believe that gambling should always be a form of
        ...
        <p>
          ...
          <a target="_blank" href="mailto:support@bonu-s.com.">
            support@bonu-s.com.
          </a>
        </p>
        ...
        <p>
          Bonu-s.com only accepts players who are at least 18 years old and
